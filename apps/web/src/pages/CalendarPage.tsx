...
export function CalendarPage() {
  ...
  return <div className="gsw-product-shell">
    <header className="gsw-product-header"><a href="/" className="gsw-wordmark"><img src="/logo-3.png" alt="" />GSW Mail</a><nav><a href="/">Mailbox</a><a href="/contacts">Contacts</a><a className="active" href="/calendar">Calendar</a><a href="/settings">Settings</a></nav></header>
    <main className="gsw-calendar-page">
