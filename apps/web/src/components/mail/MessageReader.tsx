...
import { Archive, ArrowLeft, Copy, Download, Ellipsis, Forward, Mail, Paperclip, Reply, RotateCcw, Trash2, UserPlus } from "lucide-react";
import { useState } from "react";
import type { Folder } from "../folders";
import { SenderAvatar } from "./SenderAvatar";

const fmtDate = (value: string) => new Date(value).toLocaleString(undefined, { dateStyle: "medium", timeStyle: "short" });
export function MessageReader({ message, accountId, accountAddress, folder, onBack, onReply, onReplyAll, onForward, onArchive, onTrash, onToggleRead, onRestore, onDestroy, onComposeEmail }: {
  message: FullMessage;
  accountId?: string;
