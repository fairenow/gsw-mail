...
export function FolderNav({ folder, counts, collapsed, section = "mail", onSelect }: { folder: Folder; counts: Record<Folder, { total: number; unread: number }>; collapsed: boolean; section?: "mail" | "contacts" | "calendar" | "settings"; onSelect: (folder: Folder) => void }) {
  return (
