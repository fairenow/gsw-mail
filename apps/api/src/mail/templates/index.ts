...
export const gswDefaultTemplate: MailTemplate = {
  ...
  render: (input: MailTemplateInput): RenderedMailTemplate => {
    ...
    return {
      text,
      html: `<!doctype html><html lang="en"><body style="margin:0;background:#f7f3ea;color:#484640;font-family:Arial,sans-serif;line-height:1.6"><div style="width:100%;padding:32px 16px"><div style="max-width:620px;margin:0 auto;background:#fff;border:1px solid #e8e1d4;border-radius:12px;overflow:hidden"><div style="padding:18px 24px;border-bottom:2px solid #e89a12"><img src="${mailAssetUrl("guided_steps_logo.jpg")}" alt="Guided Steps Wellness" style="display:block;width:52px;height:52px;object-fit:contain;margin-bottom:12px" /><div style="color:#292824;font-size:16px;font-weight:700">Guided Steps Wellness: The Community</div></div><div style="padding:28px 24px;font-size:15px">${body}</div><div style="padding:16px 24px;border-top:1px solid #eee9df;color:#77756f;font-size:12px">Guided Steps Wellness: The Community<br /><a href="https://thecommunity.guidedstepswellness.com/" style="color:#8d6b37;text-decoration:none">thecommunity.guidedstepswellness.com</a><br />Building community with purpose.</div></div></div></body></html>`,
    };
  },
};
